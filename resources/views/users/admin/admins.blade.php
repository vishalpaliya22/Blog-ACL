...
<div class="page-content">
	<div class="content-title">
		<h2><i class="fas fa-user-secret title-icon"></i> Administrators</h2>
	</div>

	<div class="sub-nav">
		<a href="{{ route('admin.admin-user.create') }}"><i class="fas fa-plus sub-nav-icon"></i> Add New</a>
		<span class="sub-nav-sep">|</span>
		<a href="{{ route('admin.admin-user.index') }}" class="active"><i class="fas fa-bars sub-nav-icon"></i> View List</a>
	</div>
...
$(function() {
	dtbl = $('#datatable').DataTable({
		...
		ajax: {
			method: 'POST',
			url: "{{ route('admin.admin-user.index-ahr') }}",
		},
		order: [ [0, 'asc'], [1, 'asc'] ],
		columns: [
			{
